...
your host page (see [CSS preset](css-preset.md)). The constant set covers the commonly-used icons;
...
| MudBlazor bundled CSS/JS | Tailwind v4 + daisyUI build (see [Getting started](getting-started.md)) |
...
| `MudThemeProvider` | `ThemeProvider` | parameter-driven; see [Theming](theming.md). |
...
[component reference](components/README.md) for the full list.
