...
- **Compat** — ● components with a MudBlazor-compatible API (rename `MudX` → `X`; see the
  [MudBlazor migration guide](../mudblazor-migration.md)). The rest are daisyUI-native.
...
> / `daisyblazor-dark` themes apply via [`ThemeProvider`](../theming.md).
...
See [Theming](../theming.md) for the full `ThemeProvider` parameter list and how to build a picker.
...
- [Charts](../charts.md) — the `DaisyBlazor.Charts` SVG charts.
- [MudBlazor migration](../mudblazor-migration.md) — the compatible enums, icons, dialogs and snackbar.
- [Getting started](../getting-started.md) · [Theming](../theming.md) · [CSS preset](../css-preset.md)
