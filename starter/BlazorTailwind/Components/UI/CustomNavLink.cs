...
// This version of CustomNavLink is based on the original NavLink component
// from Microsoft.AspNetCore.Components.Routing, but with the following changes:
// - The property 'InactiveClass' has been added, which allows you to specify a CSS class to be applied to the NavLink when it is not active.
...
/// </summary>
public class CustomNavLink : ComponentBase, IDisposable
{
    ...
    /// <summary>
    /// Gets or sets the CSS class name applied to the NavLink when the
    /// current route does not match the NavLink href.
    /// </summary>
    [Parameter]
    ...
    {
        CssClass = CombineWithSpace(_class, _isActive ? ActiveClass ?? DefaultActiveClass : InactiveClass ?? "");
    }
