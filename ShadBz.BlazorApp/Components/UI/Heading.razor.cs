...
public partial class Heading : ComponentBase
{
    ...
    // Core Heading properties
    [Parameter] public string As { get; set; } = "h1"; // "h1", "h2", "h3", "h4", "h5", "h6"
    [Parameter] public bool AsChild { get; set; }
    [Parameter] public string? Size { get; set; } = "6"; // "1" through "9", default "6"
    ...
    protected string CssClass
    {
        get
        {
            var builder = new CssBuilder("rt-Heading")
    ...
    protected Dictionary<string, object> GetHeadingAttributes()
    {
